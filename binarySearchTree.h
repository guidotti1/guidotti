...
public:
    ...
    void swapSubtrees(binaryTreeNode<elemType>* &p);

    void swapSubtreesRun();
...
template <class elemType>
void bSearchTreeType<elemType>::swapSubtrees(binaryTreeNode<elemType>* &p)
{
...
template <class elemType>
void bSearchTreeType<elemType>::swapSubtreesRun()
{
   swapSubtrees(root);
}
